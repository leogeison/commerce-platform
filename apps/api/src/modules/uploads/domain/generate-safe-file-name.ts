 ...
 * implementado como `S3StorageAdapter`). Conectada ao
 * `UploadImageController` via `UploadImageUseCase` (UPL-009), que gera o
 * nome aqui e repassa para `StoragePort.upload`.
 */
