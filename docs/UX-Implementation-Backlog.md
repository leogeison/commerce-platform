...
**Dentro de UXW:** `UXW-001` (agora dependente também de `UXF-001A`, além de `UXF-009`) ∥ `UXW-002` (permanece dependente só de `UXF-009`); `UXW-003` passa a depender de `UXF-010A` no lugar de `UXF-010` (cadeia transitiva preservada: `UXF-010 → UXF-010A → UXW-003`); depois de `UXW-005`, `UXW-005A` corre em sequência (não paralela — é dívida corretiva bloqueante de `UXW-006`, não uma tarefa independente); depois de `UXW-006`, `UXW-007` ∥ `UXW-008` ∥ `UXW-009`; depois de `UXW-009`, `UXW-010` ∥ `UXW-011`; `UXW-012` não depende de `UXW-009/010/011` e pode rodar assim que `UXW-007`+`UXW-008` estiverem prontos; **`UXW-014` não depende de `UXW-010/011/012/013`** e fica disponível assim que `UXW-007/008/009` terminarem — pode ser implementada bem antes de `UXW-013`, mesmo estando listada depois na numeração.
