...
**Dentro de UXW:** `UXW-001` (agora dependente também de `UXF-001A`, além de `UXF-009`) ∥ `UXW-002` (permanece dependente só de `UXF-009`); `UXW-003` passa a depender de `UXF-010A` no lugar de `UXF-010` (cadeia transitiva preservada: `UXF-010 → UXF-010A → UXW-003`); depois de `UXW-006`, `UXW-007` ∥ `UXW-008` ∥ `UXW-009`; depois de `UXW-009`, `UXW-010` ∥ `UXW-011`; `UXW-012` não depende de `UXW-009/010/011` e pode rodar assim que `UXW-007`+`UXW-008` estiverem prontos; **`UXW-014` não depende de `UXW-010/011/012/013`** e fica disponível assim que `UXW-007/008/009` terminarem — pode ser implementada bem antes de `UXW-013`, mesmo estando listada depois na numeração.
...
7. `UXW-001` e `UXW-002` podem começar assim que `UXF-010` estiver pronto (`UXW-001` também depende de `UXF-001A`, nesta revisão), sem esperar a trilha Admin. `UXW-003` (e, por dependência transitiva, `UXW-004`, `UXW-005` e `UXW-006`) passa a depender também de `UXF-010A` — o pré-requisito corretivo registrado nesta revisão — e só pode começar depois de `UXF-010A` fechar, ainda que `UXF-010` já esteja pronto. Dentro de `UXW-007…016`, aproveitar que `UXW-012` e `UXW-014` não dependem do ramo `UXW-010→011→013` — podem ser adiantadas. `UXW-011` continua sendo o ponto de espera real (depende de `UXE-018`).
