...
**Pré-requisitos:** UXA-017, UXA-018, UXA-019, UXA-019B, UXA-019A, UXA-019C.
...
Reconstruído mecanicamente a partir do campo `Pré-requisitos` de cada uma das 89 tarefas — `→` é uma dependência real listada; `∥` liga tarefas que compartilham o(s) mesmo(s) pré-requisito(s) e portanto podem rodar ao mesmo tempo; `{A,B,C} → D` significa que `D` só começa quando todas as tarefas do conjunto terminarem.
...
UXA (Admin)
  ...
  {UXF-012, UXA-012} → UXA-017 → UXA-018 → UXA-019 → UXA-019B → UXA-019A ∥ UXA-019C (ramo paralelo a UXA-013…016 desde UXA-012; UXA-017 também adiciona o item Dashboard à sidebar entregue por UXA-006 e à busca da Command Palette entregue por UXA-009, ambas via nav-destinations.ts; UXA-019A e UXA-019C são ramos irmãos, ambos dependendo só de UXA-019B, sem dependência artificial entre si)
  {UXA-019A, UXA-019C} → UXA-020 (gate E5/UX-M02)
